...
Use this in a repository named exactly `Addi-20042` so it appears on your GitHub profile.
...
Short bio options for your GitHub profile:

- Full-stack developer building React, TypeScript, and Supabase products.
- Full-stack web developer focused on practical products and clean UI.
- React and TypeScript developer building polished full-stack applications.

## Profile Setup Checklist

- Create a new public repository named `Addi-20042`
- Paste the README draft into that repo as `README.md`
- Add your real name, LinkedIn, portfolio, and email
- Pin your best 4 to 6 repositories
- Keep the tone simple, direct, and credible
