...
const firstAidGuides: FirstAidGuide[] = [
  {
    ...
    severity: "critical",
    overview: "For when someone's heart stops beating",
    steps: [
  ...
  },
  {
    ...
    severity: "critical",
    overview: "When airway is blocked by an object",
    steps: [
      "Ask 'Are you choking?' - if can't speak, act fast",
  ...
  },
  {
    ...
    severity: "critical",
    overview: "Control blood loss quickly",
    steps: [
      "Call 112",
      "Apply firm pressure with clean cloth",
      "Don't remove first cloth - add more layers",
      "Keep pressing for 10-15 minutes",
      "Elevate if possible (no broken bones)",
      "Apply tourniquet for life-threatening limb bleeding",
    ],
  ...
  },
  {
    ...
    severity: "high",
    overview: "Immediate cooling prevents damage",
    steps: [
      "Remove from heat source",
      "Cool with running water for 10-20 mins",
      "Remove jewelry near burn (if not stuck)",
      "Cover loosely with clean bandage",
      "Don't pop blisters",
      "Seek help for large/deep burns",
    ],
  ...
  },
  {
    ...
    severity: "critical",
    overview: "Time is critical - act fast",
    steps: [
      "Call 112 immediately",
  ...
  },
  {
    ...
    severity: "critical",
    overview: "Use FAST: Face, Arms, Speech, Time",
    steps: [
      "Face - ask to smile, is one side drooping?",
      "Arms - can they raise both equally?",
      "Speech - is it slurred or strange?",
      "Time - call 112 immediately if any signs",
      "Note the time symptoms started",
      "Keep them safe and monitor",
    ],
  ...
  },
  {
    ...
    severity: "critical",
    overview: "Identify and call for help",
    steps: [
      "Move to fresh air if inhaled poison",
      "Call poison control (1800-11-6117)",
      "Identify what was taken, how much, when",
      "Keep container/sample for responders",
      "Don't induce vomiting unless told",
      "Rinse skin/eyes if contact poison",
    ],
  ...
  },
  {
    ...
    severity: "critical",
    overview: "Safety first - turn off power",
    steps: [
      "DON'T touch if still connected to source",
      "Turn off power at source/breaker",
      "Separate with dry non-conducting object",
      "Call 112",
      "Check breathing, prepare for CPR",
  ...
  },
  {
    ...
    severity: "critical",
    overview: "Cool the person rapidly",
    steps: [
      "Call 112 - this is life-threatening",
      "Move to cool/shaded area",
      "Remove excess clothing",
      "Cool with ice packs at neck, armpits, groin",
      "Fan while misting with water",
      "Give cool water only if conscious",
    ],
  ...
  },
  {
    ...
    severity: "critical",
    overview: "Anaphylaxis needs immediate epinephrine",
    steps: [
      "Call 112 immediately",
      "Use EpiPen if available (outer thigh)",
      "Help them lie down, elevate legs",
      "Loosen tight clothing",
      "Monitor breathing, prepare for CPR",
      "Second EpiPen dose after 5-15 min if needed",
    ],
          ...
          <Card className="mb-6 border-destructive/30 bg-destructive/5 hover:bg-destructive/10 transition-colors cursor-pointer">
            <CardContent className="p-4 flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-semibold">Need to Call Emergency Services?</h3>
                <p className="text-sm text-muted-foreground">Access emergency numbers for ambulance, police, fire</p>
              </div>
                ...
                <AccordionItem key={guide.id} value={guide.id} className="border rounded-lg px-4">
                  ...
                  <AccordionContent className="pb-4">
                    <div className="pl-12 space-y-4">
                      <div>
                        <h4 className="font-medium text-sm mb-2 text-green-600">✓ Steps to Follow</h4>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  These guides are for educational purposes. Always call emergency services (112) in serious situations. Nothing replaces professional medical training.
                </p>
              </div>
            </div>
          </CardContent>
